...
<section 
  ...
  <div class="dc-container dc-container--limited">
    ...
    <p class="dc-p strategy__subtitle">
     This report serves as a snapshot of the current open source efforts by Zalando 
     engineering teams and gives insight into the current state of our projects, 
     contributions and usage of open source inside Zalando as of June 2018. 
    </p>
    <h2 class="dc-h2">
      Key insights
    </h2>
  ...
  <div class="dc-container dc-container--limited">
    ...
    <div class="dc-row dc--text-center">
      <div class="dc-column dc-column--small-12" 
        style="background: url({{'assets/img/report/pr-chart.png' | relative_url }}) no-repeat bottom; background-size: contain; height: 400px">
      </div>
